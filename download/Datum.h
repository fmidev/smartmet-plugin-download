...
enum class DatumShift
{
  ...
  HPDefaultScale,     // Using default scaling when getting Helmert transformation parameters (same
                      // as WGS84)
  HPPreserveEWScale,  // Preserving east/west scale when getting Helmert transformation
                      // parameters.
  HPPreserveSNScale   // Preserving south/north scale when getting Helmert transformation
                      // parameters.
};
